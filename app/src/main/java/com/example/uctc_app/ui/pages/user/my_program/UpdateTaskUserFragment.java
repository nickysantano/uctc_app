...
import com.example.uctc_app.ui.pages.staff.action_plan.UpdateTaskStaffFragmentArgs;
import com.example.uctc_app.ui.pages.staff.action_plan.UpdateTaskStaffFragmentDirections;
...
public class UpdateTaskUserFragment extends Fragment {
...
//    Spinner spinner_pic;
    ...
    public UpdateTaskUserFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_update_task_user, container, false);
    }
...
//        namaTeamId.get(spinner_pic.getSelectedItemPosition());
        ...
        btnUpdateTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UpdateTaskUserFragmentDirections.ActionUpdateTaskUserToTaskUser actionUpdateTaskUserToTaskUser =
                        UpdateTaskUserFragmentDirections.actionUpdateTaskUserToTaskUser(actionPlan_id, program_id);
                Navigation.findNavController(v).navigate(actionUpdateTaskUserToTaskUser);
            }
        });
    }
