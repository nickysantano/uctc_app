...
import com.example.uctc_app.ui.pages.staff.action_plan.AddTaskStaffFragmentDirections;
...
public class AddTaskUserFragment extends Fragment {
    ...
    public AddTaskUserFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_add_task_user, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AddTaskUserFragmentDirections.ActionAddTaskUserToTaskFragment actionAddTaskUserToTaskFragment =
                        AddTaskUserFragmentDirections.actionAddTaskUserToTaskFragment(actionPlan_id, program_id);
                Navigation.findNavController(v).navigate(actionAddTaskUserToTaskFragment);
            }
        });
    }
